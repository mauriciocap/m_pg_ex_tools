...
function rtInitImpl() {
	...
	var s10= function () { evalUpdated(CFGLIB.initFile0,s12,s11); }
...
function initScreen() { //D: pantalla inicial ofreciendo Run, Run con debug (alerts) y bajarse la app
	$(document.body).html('<center style="font-size: 200%; height: 2048px; width: '+window.innerWidth+'; background: #087;"><h1>Enerminds Prometium Rt (desarrollo)</h1><br><big><p><button id="btnRun">GO</button><br></big><p><button id="btnRunDbg">dbg</button><p><input id="appUrl" value="'+CFGLIB.appUrl+'" style="width: 100%;"></center>');
